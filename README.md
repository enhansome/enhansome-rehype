...
[<img align="right" alt src="https://raw.githubusercontent.com/rehypejs/rehype/26ea958/logo-square.svg?sanitize=true" width="200">](https://github.com/rehypejs/rehype) ⭐ 2,257 | 🐛 1 | 🌐 JavaScript | 📅 2026-06-13
...
* [rehype](https://github.com/rehypejs/rehype) ⭐ 2,257 | 🐛 1 | 🌐 JavaScript | 📅 2026-06-13 - Repository.
* [rehype-parse](https://github.com/rehypejs/rehype/tree/HEAD/packages/rehype-parse) ⭐ 2,257 | 🐛 1 | 🌐 JavaScript | 📅 2026-06-13 - HTML parser.
* [rehype-stringify](https://github.com/rehypejs/rehype/tree/HEAD/packages/rehype-stringify) ⭐ 2,257 | 🐛 1 | 🌐 JavaScript | 📅 2026-06-13 - HTML generator.
* [rehype-cli](https://github.com/rehypejs/rehype/tree/HEAD/packages/rehype-cli) ⭐ 2,257 | 🐛 1 | 🌐 JavaScript | 📅 2026-06-13 - Command line interface.
...
* [rehype-highlight](https://github.com/rehypejs/rehype-highlight) ⭐ 331 | 🐛 0 | 🌐 JavaScript | 📅 2025-02-21 - Highlight code blocks with [lowlight](https://github.com/wooorm/lowlight) ⭐ 926 | 🐛 6 | 🌐 JavaScript | 📅 2024-12-14 (Highlight.js).
...
[Find more plugins »](https://github.com/rehypejs/rehype/blob/HEAD/doc/plugins.md#list-of-plugins) ⭐ 2,257 | 🐛 1 | 🌐 JavaScript | 📅 2026-06-13

## Built on rehype

* [Gatsby](https://github.com/gatsbyjs/gatsby) ⭐ 55,943 | 🐛 449 | 🌐 JavaScript | 📅 2026-09-25 - Blazing fast, modern apps and websites with React.
* [MDX](https://github.com/mdx-js/mdx) ⭐ 19,802 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-24 - Markdown combined with JSX.
...
* [nteract](https://github.com/nteract/nteract) ⭐ 176 | 🐛 41 | 🌐 Rust | 📅 2026-09-25 - Interactive computing suite for you.
...
* [freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp) ⭐ 456,120 | 🐛 209 | 🌐 TypeScript | 📅 2026-09-25 - Learn to code for free.
* [Node.js](https://github.com/nodejs/node) ⭐ 122,080 | 🐛 1,198 | 🌐 JavaScript | 📅 2026-09-25 - Node.js JavaScript runtime.
* [angular](https://github.com/angular/angular) ⭐ 101,035 | 🐛 1,153 | 🌐 TypeScript | 📅 2026-09-24 - Development platform for mobile and desktop apps.
* [rxjs](https://github.com/ReactiveX/rxjs) ⭐ 31,703 | 🐛 188 | 🌐 TypeScript | 📅 2026-08-08 - Reactive Extensions For JavaScript.
* [stdlib](https://github.com/stdlib-js/stdlib) ⭐ 5,973 | 🐛 1,528 | 🌐 JavaScript | 📅 2026-09-25 - Standard library emphasizing numerical and scientific applications.
